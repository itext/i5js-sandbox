...
public class S03_CorrectedWatermark {
    ...
    public static final String DEST
        = "results/javaone/edition2014/03_corrected_watermark.pdf";
    ...
    public void manipulatePdf(String src, String dest) throws DocumentException, IOException {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            ColumnText.showTextAligned(under, Element.ALIGN_CENTER, new Phrase("Watermark", new Font(FontFamily.HELVETICA, 120)), x, y, 45);
            under.restoreState();
        }
        stamper.close();
        reader.close();
